...
class VolatilityLimitEntryV2_fast(IStrategy):
    INTERFACE_VERSION = 3
    ...
    atr_mult = DecimalParameter(1.5, 3.0, default=1.0, decimals=1, space='buy', optimize=True)
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['is_trending'] = dataframe['adx_4h'] >= 15.0
